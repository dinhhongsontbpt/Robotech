...
namespace Cutreson_UserControl
{
    public partial class UcDateTime : UserControl
    {
        ...
        private void Loading()
        {
            Thread run = new Thread(() =>
            {
                while (isRun)
                {
                    clsInvokeControl.ControlTextInvoke(lbDate, DateTime.Now.ToString("yyyy-MM-dd"));
                    clsInvokeControl.ControlTextInvoke(lbDay, DateTime.Now.ToString("dddd").ToUpper());
                    clsInvokeControl.ControlTextInvoke(lbTime, DateTime.Now.ToString("HH:mm:ss"));
                    Thread.Sleep(1000);
                }
            });
            run.Name = "UcDateTime";
    ...
    partial class UcDateTime
    {
        ...
        private void InitializeComponent()
        {
            ...
            // panelSaperator
            // 
            this.panelSaperator.BackColor = System.Drawing.Color.Violet;
